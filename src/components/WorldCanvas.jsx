    ...
    const loop = (now) => {
      ...
      if (isSkyMode) {
        ...
        if (lit) {
          ...
          monolithGlow.addColorStop(0, "rgba(255,214,168,0.18)");
          monolithGlow.addColorStop(0.5, "rgba(255,206,150,0.08)");
          ...
          beam.addColorStop(0, "rgba(255,212,170,0)");
          beam.addColorStop(0.5, "rgba(255,212,170,0.06)");
          beam.addColorStop(1, "rgba(255,212,170,0)");
          ctx.globalCompositeOperation = "screen";
          ctx.fillStyle = beam;
          ctx.fillRect(0, 0, W, H);
          ctx.restore();
